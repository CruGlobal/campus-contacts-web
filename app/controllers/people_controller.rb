    ...
    Person.transaction do
      ...
      if @person.save
        ...
        if params[:roles].present?
          ...
          if role_ids.include?(Role::MISSIONHUB_USER_ID) || role_ids.include?(Role::ADMIN_ID)
          ...
          role_ids.each do |role_id|
            begin
              ...
              flash.now[:error] = I18n.t('people.create.error_creating_leader_no_valid_email') if role_id == Role::MISSIONHUB_USER_ID.to_s
  ...
  def update_roles
    ...
    all.each_with_index do |role_id, index|
      begin
        ...
        render 'update_leader_error', :locals => { :person => person } if role_id == Role::MISSIONHUB_USER_ID
