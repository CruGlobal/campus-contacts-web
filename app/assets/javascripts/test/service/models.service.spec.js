    ...
    describe('modelsService', function () {
        ...
        describe('getModelUrl', function () {
            it('should return the URL for models', function () {
                expect(modelsService.getModelUrl({ _type: 'person', id: 1 })).toBe('/people/1');
                expect(modelsService.getModelUrl({ _type: 'organization', id: 2 })).toBe('/organizations/2');
                expect(modelsService.getModelUrl({ _type: 'group', id: 3 })).toBe('/groups/3');
            });
