...
(function (Handsontable) {
  ...
  SelectEditor.prototype.open = function () {
    ...
    if(this.TD.innerHTML != ""){
      var values = this.TD.innerHTML.split("<")[0]
      var value = $.map(values.split(","), function(e,i) {return $.trim(e)})
      console.log(values)
...
WalkontableVerticalScrollbarNative.prototype.resetFixedPosition = function () {
  ...
  if (this.scrollHandler === window) {
    ...
    // Adjust top most view
    var maxTop = 131;
    if (top < maxTop && (bottom - elem.offsetHeight) > maxTop) {
      finalTop = -top + maxTop + "px";
    } else {
      finalTop = "0";
    }
  }
