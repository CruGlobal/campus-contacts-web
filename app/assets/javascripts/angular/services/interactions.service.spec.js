...
// Constants
let interactionsService, $q, $rootScope, httpProxy, reportsService, JsonApiDataStore, _;
    ...
    it(
      ...
      asynchronous(function () {
        ...
        return interactionsService
          .recordInteraction(this.interaction, this.organizationId, this.initiatorId)
    ...
    it(
      ...
      asynchronous(function () {
        ...
        return interactionsService
          .recordInteraction(this.interaction, this.organizationId, this.initiatorId)
          .then(function () {
            expect(reportsService.lookupPersonReport).toHaveBeenCalledWith(_this.organizationId, _this.initiatorId);

            expect(reportsService.lookupOrganizationReport).toHaveBeenCalledWith(_this.organizationId);
