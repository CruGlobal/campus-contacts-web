(function () {
    ...
    // Constants
    var interactionsService, $q, $rootScope, httpProxy, reportsService, JsonApiDataStore, _;
    ...
    describe('interactionsService', function () {
        ...
        describe('updateInteraction', function () {
            ...
            it('should save interaction changes to the server', asynchronous(function () {
                var _this = this;
        ...
        describe('deleteInteraction', function () {
            ...
            it('should delete interactions from the server', asynchronous(function () {
                var _this = this;
