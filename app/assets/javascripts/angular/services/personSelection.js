angular.module('campusContactsApp').factory('personSelectionService', personSelectionService);
  ...
  var personSelectionService = {
    ...
    convertToFilters: function (selection) {
      ...
      return _.pickBy({
        ...
        ...(selection.surveyId || filters.questions || filters.answerMatchingOptions
          ? {
              answer_sheets: {
