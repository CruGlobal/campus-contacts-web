...
function periodService($window, $rootScope) {
  const defaultPeriod = 'P3M';
  let period = null;
  const changeEventName = 'periodService.period-change';
  ...
  return {
    ...
    getPeriods: function () {
      return [
        ...
        {
          label: 'dashboard.report_periods.three_months',
          period: 'P3M',
        },
    ...
    subscribe: function ($scope, callback) {
      const unsubscribe = $rootScope.$on(changeEventName, callback);
