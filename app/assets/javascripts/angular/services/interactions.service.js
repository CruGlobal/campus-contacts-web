    ...
    return {
        ...
        recordInteraction: function(interaction, organizationId, personId) {
            ...
            return httpProxy
                .post(
                    ...
                    {
                        errorMessage:
                            'error.messages.interactions.create_interaction',
                    },
                )
                ...
                .then(function(interaction) {
                    ...
                    if (person && person.interactions) {
                        person.interactions = person.interactions.concat(
                            interaction,
                        );
                    }
        ...
        updateInteraction: function(interaction) {
            return httpProxy
                .put(
                    ...
                    {
                        errorMessage:
                            'error.messages.interactions.update_interaction',
                    },
                )
                .then(httpProxy.extractModel);
        },
        ...
        deleteInteraction: function(interaction) {
            return httpProxy.delete(
                ...
                {
                    errorMessage:
                        'error.messages.interactions.delete_interaction',
                },
            );
        },
    };
