...
// Constants
let ProgressiveListLoader, $rootScope, $q, httpProxy, _;
  ...
  describe('loadMore', function () {
    it(
      ...
      asynchronous(function () {
        ...
        return this.listLoader.loadMore({ include: 'phone_numbers' }).then(function (resp) {
          const respIds = _.map(resp.list, 'id');
    ...
    it(
      ...
      asynchronous(function () {
        ...
        this.responsePeople = [{ id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }];
