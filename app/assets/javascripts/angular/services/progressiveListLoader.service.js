angular.module('campusContactsApp').factory('ProgressiveListLoader', progressiveListLoader);
...
function progressiveListLoader(httpProxy, modelsService, _) {
  ...
  function ProgressiveListLoader(options) {
    ...
    this.loadMore = function (params = {}, transformData = (params) => (data) => data) {
      ...
      return httpProxy
        .get(modelsService.getModelMetadata(modelType).url.all, params, {
