angular
  ...
  .run(function (
    ...
    if (authenticationService.isTokenValid()) authenticationService.setupAuthenticationState();
    ...
    $transitions.onBefore({}, (transition) => {
      if (transition.to().data && transition.to().data.isPublic) return true;
      ...
      if (
        ...
        return transition.router.stateService.target('app.ministries.signAgreements');
      }
