...
angular.module('campusContactsApp').config(function (rollbarAccessToken, envServiceProvider, $provide, _) {
  const rollbarConfig = {
  ...
  $provide.decorator('$log', function ($delegate) {
    ...
    angular.forEach(['log', 'debug', 'info', 'warn', 'error'], function (ngLogLevel) {
      ...
      $delegate[ngLogLevel] = function () {
        ...
        const origin = arguments[0] && arguments[0].stack ? '$ExceptionHandler' : '$log';
