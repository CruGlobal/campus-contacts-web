...
angular.module('campusContactsApp').component('organizationOverviewSurveyResponses', {
  require: {
...
function organizationOverviewSurveyResponsesController($scope, surveyService, periodService) {
  this.surveyStats = {};
  this.$onInit = () => {
    // get survey stats
    this.getSurveyStats();
