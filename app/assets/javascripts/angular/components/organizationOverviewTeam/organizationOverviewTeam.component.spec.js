describe('organizationOverviewTeam component', function () {
  let $ctrl, $q, $rootScope, organizationOverviewTeamService, reportsService, periodService;

  beforeEach(inject(function ($componentController, _$q_, _$timeout_, _$rootScope_) {
    organizationOverviewTeamService = jasmine.createSpyObj('organizationOverviewTeamService', ['loadOrgTeam']);
    reportsService = jasmine.createSpyObj('reportsService', ['loadMultiplePeopleReports']);
  ...
  describe('loadTeamPage', function () {
    it('should load the people on the team', function () {
      ...
      $ctrl.loadTeamPage();
      expect(organizationOverviewTeamService.loadOrgTeam).toHaveBeenCalledWith({ id: 1 }, jasmine.any(Object));
      $rootScope.$digest();
