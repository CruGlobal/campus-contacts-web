...
describe('peopleScreenService', function () {
  beforeEach(inject(function (_peopleScreenService_, _httpProxy_, _$rootScope_, _$q_) {
  ...
  describe('loadOrgPeopleCount', function () {
    it(
      ...
      asynchronous(function () {
        ...
        return peopleScreenService.loadOrgPeopleCount(this.orgId).then(function (personCount) {
