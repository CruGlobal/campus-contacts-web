(function () {
    ...
    function mergeWinnerService (httpProxy, modelsService, dateFilter, _) {
        var mergeWinnerService = {
            ...
            personFields: [
                'first_name', 'last_name', 'gender', 'email_addresses', 'phone_numbers',
                'created_date', 'updated_date'
            ],

            // The fields of a choice.user object
            userFields: [
                'id', 'username', 'created_date', 'updated_date', 'login_date'
            ],
            ...
            generateChoices: function (personIds) {
                ...
                return httpProxy
                    .get(modelsService.getModelMetadata('person').url.all, {
