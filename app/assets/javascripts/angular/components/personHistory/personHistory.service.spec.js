    ...
    describe('personHistoryService', function () {
        ...
        describe('buildHistoryFeed', function () {
            ...
            it('should show just interactions', function () {
                expect(personHistoryService.buildHistoryFeed(this.person, 'interactions', 1)).toEqual([
                    this.interaction
                ]);
            });

            it('should show just notes', function () {
                expect(personHistoryService.buildHistoryFeed(this.person, 'notes', 1)).toEqual([
                    this.note
                ]);
            });
