...
function personProfileController(
    ...
    function activate() {
        ...
        vm.disableNameFields =
            ...
            loggedInPerson.person !== vm.personTab.person;
    ...
    function isEmailAddressValid(emailAddress) {
        var control =
            vm.form['email_address_' + (emailAddress.id || 'pending')];
        return (
            control.$valid ||
            (control.$viewValue === '' &&
                vm.isPendingEmailAddress(emailAddress))
        );
    }
    ...
    function addEmailAddress() {
        ...
        vm.pendingEmailAddress.setAttribute(
            'person_id',
            vm.personTab.person.id,
        );
