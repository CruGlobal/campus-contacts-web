(function () {
    ...
    angular
        ...
        .component('ministryViewLabel', {
            controller: ministryViewLabelController,
            templateUrl: /* @ngInject */ function (templateUrl) {
                return templateUrl('ministryViewLabel');
            },
            bindings: {
                label: '<'
            }
    ...
    function ministryViewLabelController ($uibModal, confirmModalService, tFilter,
                                          labelsService, loggedInPerson, _) {
        var vm = this;
        ...
        function deleteLabel () {
            return confirmModalService.create(tFilter('labels.delete.confirm', { label_name: vm.label.name }))
                .then(function () {
