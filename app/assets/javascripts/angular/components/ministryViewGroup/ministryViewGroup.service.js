(function () {
    ...
    function ministryViewGroupService (groupsService, tFilter, moment, _) {
        ...
        function formatOrdinal (number) {
            ...
            var suffix = (tensDigit !== 1 && onesDigit >= 1 && onesDigit <= 3) ? suffixes[onesDigit] : suffixes[0];
        ...
        function formatMeetingTime (group) {
            ...
            if (group.meets === 'weekly') {
                ...
                return tFilter('ministries.groups.meeting_time.weekly', { time: time, day: dayOfWeek });
            } else if (group.meets === 'monthly') {
                var dayOfMonth = formatOrdinal(group.meeting_day);
                return tFilter('ministries.groups.meeting_time.monthly', { time: time, day: dayOfMonth });
