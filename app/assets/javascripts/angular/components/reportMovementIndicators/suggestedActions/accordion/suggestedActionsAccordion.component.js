...
angular.module('campusContactsApp').component('reportMovementIndicatorsSuggestedActionsAccordion', {
  ...
  this.getLabelQuestion = (action) =>
    $sce.trustAsHtml(
      i18next.t('movementIndicators:suggestedActions.applyLabel', {
        label: action.label.i18n ? i18next.t(action.label.i18n) : action.label.name,
      }),
    );
}
