...
class Organization < ActiveRecord::Base
  ...
  has_many :all_people_with_archived, through: :organizational_roles, source: :person, conditions: ["(organizational_roles.followup_status <> 'do_not_contact' OR organizational_roles.followup_status IS NULL) AND organizational_roles.archive_date IS NULL"]  
