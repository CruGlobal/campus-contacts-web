...
class Organization < ActiveRecord::Base
  ...
  has_many :leaders, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id IN (?) AND organizational_roles.deleted = ?", Role.leader_ids, 0], order: "ministry_person.lastName, ministry_person.preferredName, ministry_person.firstName", uniq: true
  has_many :only_leaders, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ?", Role::LEADER_ID, 0], order: "ministry_person.lastName, ministry_person.preferredName, ministry_person.firstName", uniq: true
  has_many :admins, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ?", Role::ADMIN, 0], order: "ministry_person.lastName, ministry_person.preferredName, ministry_person.firstName", uniq: true
  has_many :all_contacts, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ?", Role::CONTACT_ID, 0]
  ...
  has_many :dnc_contacts, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ? AND organizational_roles.followup_status = ?", Role::CONTACT_ID, 0, 'do_not_contact']
  has_many :completed_contacts, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ? AND organizational_roles.followup_status = ?", Role::CONTACT_ID, 0, 'completed']
  has_many :inprogress_contacts, through: :contact_assignments, source: :person
  has_many :no_activity_contacts, through: :organizational_roles, source: :person, conditions: ["organizational_roles.role_id = ? AND organizational_roles.deleted = ? AND organizational_roles.followup_status = ?", Role::CONTACT_ID, 0, 'uncontacted']
