...
function inviteLinkController(
  ...
  this.$onInit = async () => {
    this.expiredText = $sce.trustAsHtml($filter('t')('mergeAccount.inviteLinkExpiredMessage'));

    const inviteState = setInviteState(this.rememberCode, this.userId, this.orgId);
