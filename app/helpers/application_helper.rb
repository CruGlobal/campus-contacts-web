module ApplicationHelper
  ...
  def link_to_remove_fields(f, hidden)
    f.hidden_field(:_destroy) + link_to(' ', '#', class: 'remove_field tip', title: 'Remove', style: hidden ? 'display:none' : '')
  end
  ...
  def no_left_sidebar
    ...
    when 'groups/create', 'groups/update', 'organizations/update',
         'organizations/new', 'organizations/api', 'organizations/settings',
