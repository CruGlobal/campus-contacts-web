...
class ContactsControllerTest < ActionController::TestCase
  ...
  context 'set_labels' do
    ...
    should 'add labels' do
      xhr :post, :set_labels,                    people_ids: [@person1.id, @person2.id, @person3.id].join(','),
    ...
    should 'not duplicate labels' do
      ...
      xhr :post, :set_labels,                    people_ids: @person3.id.to_s,
    ...
    should 'remove labels' do
      xhr :post, :set_labels,                    people_ids: [@person1.id, @person2.id, @person3.id].join(','), label_ids: '',
