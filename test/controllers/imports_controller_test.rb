...
class ImportsControllerTest < ActionController::TestCase
  ...
  context "Importing contacts" do
    setup do
      ...
      @first_name_element = FactoryGirl.create(:first_name_element)
      @last_name_element = FactoryGirl.create(:last_name_element)
      @email_element = FactoryGirl.create(:email_element)
      @phone_element = FactoryGirl.create(:phone_element)
      @first_name_question = FactoryGirl.create(:survey_element, survey: @survey, element: @first_name_element, position: 1, archived: true)
      @last_name_question = FactoryGirl.create(:survey_element, survey: @survey, element: @last_name_element, position: 2, archived: true)
      @email_question = FactoryGirl.create(:survey_element, survey: @survey, element: @email_element, position: 3, archived: true)
      @phone_question = FactoryGirl.create(:survey_element, survey: @survey, element: @phone_element, position: 4, archived: true)
