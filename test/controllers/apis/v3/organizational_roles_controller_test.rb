...
class Apis::V3::OrganizationalRolesControllerTest < ActionController::TestCase
  ...
  #   @user = FactoryGirl.create(:user_no_org)
  #   @person = @user.person
  ...
  #   @label = FactoryGirl.create(:label, organization: @org)
  #
  #   FactoryGirl.create(:organizational_label, organization: @org, person: @person, label: @label)
  #
  ...
  #     FactoryGirl.create(:organizational_label, organization: @org, person: @person1, label: @label)
  #     FactoryGirl.create(:organizational_label, organization: @org, person: @person2, label: @label)
