...
class Apis::V3::ContactAssignmentsControllerTest < ActionController::TestCase
  ...
  context ".show" do
    setup do
      @sample_person = FactoryGirl.create(:person)
      @org.add_contact(@sample_person)
      @contact_assignment = FactoryGirl.create(:contact_assignment, organization_id: @org.id, assigned_to: @person1, person: @sample_person)
    end
    context "ADMIN request" do
      setup do
        @token = @admin_token.code
  ...
  context ".create" do
    setup do
      @new_user = FactoryGirl.create(:user_no_org)
  ...
  context ".update" do
    setup do
      ...
      @contact_assignment = FactoryGirl.create(:contact_assignment, organization_id: @org.id, assigned_to: @person1, person: @new_person)
  ...
  context ".bulk_update" do
    setup do
      ...
      @org.add_contact(@new_person)
      @org.add_contact(@another_person)
      @contact_assignment1 = FactoryGirl.create(:contact_assignment, organization_id: @org.id, assigned_to: @person2, person: @new_person)
      @contact_assignment2 = FactoryGirl.create(:contact_assignment, organization_id: @org.id, assigned_to: @person2, person: @another_person)
      @admin_person = FactoryGirl.create(:person)
      FactoryGirl.create(:email_address, email: 'admin@email.com', person: @admin_person)
    end
    context "ADMIN request" do
      setup do
        @token = @admin_token.code
