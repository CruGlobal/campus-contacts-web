...
class Apis::V3::FollowupCommentsControllerTest < ActionController::TestCase
  setup do
    ...
    @followup_comment = FactoryGirl.create(:interaction_type, organization_id: 0, i18n: 'comment')
    @followup_comment = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person1)
  end
