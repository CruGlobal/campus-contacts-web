...
class Apis::V3::InteractionsControllerTest < ActionController::TestCase
  setup do
    ...
    @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person1, comment: 'Comment')
  end
  ...
  context '.update' do
    context 'ADMIN request' do
      ...
      should 'not update and return an interaction from other user' do
        @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person3, comment: 'Comment')
        put :update, access_token: @token, id: @interaction.id,
                     interaction: { comment: 'New Comment' }
        json = JSON.parse(response.body)
        assert_not_nil json['errors'], json.inspect
    ...
    context 'USER request' do
      ...
      should 'update and return an interaction' do
        @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person2, comment: 'Comment')
        put :update, access_token: @token, id: @interaction.id,
                     interaction: { comment: 'New Comment' }
        assert_response :success
        json = JSON.parse(response.body)
  ...
  context '.destroy' do
    context 'ADMIN request' do
      ...
      should 'destroy an interaction' do
        @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person1)
      ...
      should 'not destroy an interaction from other user' do
        @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person3)
        delete :destroy, access_token: @token, id: @interaction.id
        json = JSON.parse(response.body)
        assert_not_nil json['errors'], json.inspect
        @interaction.reload
    ...
    context 'USER request' do
      ...
      should 'destroy an interaction' do
        @interaction = FactoryGirl.create(:interaction, organization: @org, receiver: @person, creator: @person2)
        delete :destroy, access_token: @token, id: @interaction.id
        assert_response :success
        json = JSON.parse(response.body)
        @interaction.reload
