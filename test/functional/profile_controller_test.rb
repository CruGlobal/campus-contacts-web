...
class ProfileControllerTest < ActionController::TestCase
  ...
  setup do
    ...
    @contact = Factory(:person, first_name: "Contact", last_name: "One")
    @org.add_contact(@contact)

    @other_org = Factory(:organization)
    @other_contact = Factory(:person, first_name: "Contact", last_name: "One")
  ...
  context "Viewing a profile" do
    ...
    should "load the leaders whom person is assigned to" do
      Factory(:contact_assignment, organization: @org, assigned_to: @user.person, person: @contact)
      get :show, id: @contact.id
