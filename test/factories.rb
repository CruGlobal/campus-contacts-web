...
=end
  ...
  factory :question_grid_with_total do
    kind          'QuestionGridWithTotal'
    label         'How soon is now?'
    style         'question_grid'
    object_name ''
    attribute_name ''
