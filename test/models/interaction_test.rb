...
class InteractionTest < ActiveSupport::TestCase
  ...
  context 'Interaction feed' do
    setup do
      ...
      @org1 = FactoryGirl.create(:organization, ancestry: "#{@parent1.id}/#{@parent2.id}")
      @org2 = FactoryGirl.create(:organization)

      @org1user1 = FactoryGirl.create(:user_with_auxs)
      @org1admin1 = @org1user1.person
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @org1admin1, permission: Permission.admin)
      @org1user2 = FactoryGirl.create(:user_with_auxs)
      @org1admin2 = @org1user2.person
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @org1admin2, permission: Permission.admin)
      @org1user3 = FactoryGirl.create(:user_with_auxs)
      @org1contact = @org1user3.person
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @org1contact, permission: Permission.no_permissions)

      @org2user1 = FactoryGirl.create(:user_with_auxs)
      @org2admin1 = @org2user1.person
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @org2admin1, permission: Permission.admin)
      @org2user2 = FactoryGirl.create(:user_with_auxs)
      @org2contact = @org2user2.person
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @org2contact, permission: Permission.no_permissions)

      @parent1user1 = FactoryGirl.create(:user_with_auxs)
      @parent1admin1 = @parent1user1.person
      FactoryGirl.create(:organizational_permission, organization: @parent1, person: @parent1admin1, permission: Permission.admin)
      @parent1user2 = FactoryGirl.create(:user_with_auxs)
      @parent1contact = @parent1user2.person
      FactoryGirl.create(:organizational_permission, organization: @parent1, person: @parent1contact, permission: Permission.no_permissions)

      @parent2user1 = FactoryGirl.create(:user_with_auxs)
      @parent2admin1 = @parent2user1.person
      FactoryGirl.create(:organizational_permission, organization: @parent2, person: @parent2admin1, permission: Permission.admin)
      @parent2user2 = FactoryGirl.create(:user_with_auxs)
      @parent2contact = @parent2user2.person
      FactoryGirl.create(:organizational_permission, organization: @parent2, person: @parent2contact, permission: Permission.no_permissions)

      @interaction1 = FactoryGirl.create(:interaction, organization: @org1, creator: @org1admin1, receiver: @org1contact)
    end
