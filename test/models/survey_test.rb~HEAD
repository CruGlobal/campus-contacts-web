...
class SurveyTest < ActiveSupport::TestCase
  ...
  context "getting question rules of a survey" do
    ...
    should "return the question rules of survey elements" do
      @survey_element1 = FactoryGirl.create(:survey_element, survey: @survey1, element: @element1, position: 1)
      @survey_element2 = FactoryGirl.create(:survey_element, survey: @survey1, element: @element2, position: 2)
      @question_rule1 = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element1)
      @question_rule2 = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element2)
    ...
    should "not return the question rules of other survey" do
      @survey_element1 = FactoryGirl.create(:survey_element, survey: @survey1, element: @element1, position: 1)
      @survey_element2 = FactoryGirl.create(:survey_element, survey: @survey2, element: @element2, position: 2)
      @question_rule1 = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element1)
      @question_rule2 = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element2)
      results = @survey1.question_rules
  ...
  context "checking survey if it have automated assignment rule" do
    ...
    should "return true if it has autoassign question_rule type = 'group'" do
      ...
      @question_rule = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element, extra_parameters: @extra)
    ...
    should "return false if question rule dont have parameters" do
      @survey_element = FactoryGirl.create(:survey_element, survey: @survey, element: @element, position: 1)
      @question_rule = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element, extra_parameters: "")
      result = @survey.has_assign_rule('group')
      assert_equal(result, false, 'should return false')
    end
  end
  ...
  context "checking survey if it have applied automated assignment rule to an answer" do
    ...
    should "return false if it has autoassign question_rule type = 'group' but not triggered" do
      @answer = FactoryGirl.create(:answer, answer_sheet: @answer_sheet, question: @element, value: 'fine')
      @survey_element = FactoryGirl.create(:survey_element, survey: @survey, element: @element, position: 1)
      @question_rule = FactoryGirl.create(:question_rule, rule: @rule, survey_element: @survey_element,
        extra_parameters: @extra, trigger_keywords: @triggers)
      result = @survey.has_assign_rule_applied(@answer_sheet, 'group')
