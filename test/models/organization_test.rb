...
class OrganizationTest < ActiveSupport::TestCase
  ...
  context "get all people" do
    setup do
      ...
      FactoryGirl.create(:organizational_permission, person: @person2, permission: Permission.no_permissions, organization: @org1, :added_by_id => @person1.id)
      FactoryGirl.create(:organizational_permission, person: @person3, permission: Permission.no_permissions, organization: @org1, :added_by_id => @person1.id)
    end
  ...
  context "get all leaders" do
    setup do
      ...
      @leader1 = FactoryGirl.create(:person, email: 'leader1@email.com')
      @leader2 = FactoryGirl.create(:person, email: 'leader2@email.com')
      @leader3 = FactoryGirl.create(:person, email: 'leader3@email.com')
      @contact = FactoryGirl.create(:person)
      FactoryGirl.create(:organizational_permission, person: @contact, permission: Permission.no_permissions, organization: @org1, :added_by_id => @person.id)
      FactoryGirl.create(:organizational_permission, person: @leader1, permission: Permission.user, organization: @org1, :added_by_id => @person.id)
      FactoryGirl.create(:organizational_permission, person: @leader2, permission: Permission.user, organization: @org1, :added_by_id => @person.id)
      FactoryGirl.create(:organizational_permission, person: @leader3, permission: Permission.user, organization: @org2, :added_by_id => @person.id)
    end
  ...
  context "parent_organization method" do
    setup do
      ...
      @org2 = FactoryGirl.create(:organization, id: '2', ancestry: '1')
      @org3 = FactoryGirl.create(:organization, id: '3', ancestry: '1/2')
    end
  ...
  context "parent_organization_admins method" do
    setup do
      @person1 = FactoryGirl.create(:person)
      FactoryGirl.create(:email_address, email: "person1@email.com", person: @person1)
      @person2 = FactoryGirl.create(:person, email: "person2@email.com")
      FactoryGirl.create(:email_address, email: "person2@email.com", person: @person2)
      @person3 = FactoryGirl.create(:person, email: "person3@email.com")
      FactoryGirl.create(:email_address, email: "person3@email.com", person: @person3)
      @person4 = FactoryGirl.create(:person, email: "person4@email.com")
      FactoryGirl.create(:email_address, email: "person4@email.com", person: @person4)
      @person5 = FactoryGirl.create(:person, email: "person5@email.com")
      FactoryGirl.create(:email_address, email: "person5@email.com", person: @person5)
      @person6 = FactoryGirl.create(:person, email: "person6@email.com")
      FactoryGirl.create(:email_address, email: "person6@email.com", person: @person6)
      @org1 = FactoryGirl.create(:organization, id: '1')
      @org2 = FactoryGirl.create(:organization, id: '2', ancestry: '1')
      @org3 = FactoryGirl.create(:organization, id: '3', ancestry: '1/2')
      @org4 = FactoryGirl.create(:organization, id: '4', ancestry: '1/2/3', show_sub_orgs: false)
      @org5 = FactoryGirl.create(:organization, id: '5', ancestry: '1/2/3/4')
      @org6 = FactoryGirl.create(:organization, id: '6', ancestry: '1/2/3/4/5')
    end

    should "return the admins of org1" do
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person2, permission: Permission.admin)
    ...
    should "return the admins of org2" do
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person2, permission: Permission.admin)
    ...
    should "return the admins of org3" do
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person2, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person3, permission: Permission.admin)
    ...
    should "return the admins of org4" do
      ...
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person2, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person3, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org4, person: @person4, permission: Permission.admin)
    ...
    should "return the admins of org5" do
      ...
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person3, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org4, person: @person4, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org5, person: @person5, permission: Permission.admin)
    ...
    should "return the admins of org6" do
      ...
      FactoryGirl.create(:organizational_permission, organization: @org4, person: @person4, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org5, person: @person5, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org6, person: @person6, permission: Permission.admin)
  ...
  context "all_possible_admins method" do
    setup do
      @person1 = FactoryGirl.create(:person, email: "person1@email.com")
      @person2 = FactoryGirl.create(:person, email: "person2@email.com")
      @person3 = FactoryGirl.create(:person, email: "person3@email.com")
      @person4 = FactoryGirl.create(:person, email: "person4@email.com")
      @org1 = FactoryGirl.create(:organization, id: '1')
    ...
    should "return the admins of org3" do
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person2, permission: Permission.admin)
    ...
    should "return the admins of org2" do
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person2, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org2, person: @person3, permission: Permission.admin)
      results = @org3.all_possible_admins
    ...
    should "return null" do
      results = @org3.all_possible_admins
      assert_equal [], results, "when org3 and org2 and org1 dont have admins"
    end
  end
  ...
  context "all_possible_admins_with_email method" do
    ...
    should "return the admins of org1" do
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person1, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person2, permission: Permission.admin)
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person3, permission: Permission.admin)
      @person3.email_addresses.destroy_all
      FactoryGirl.create(:organizational_permission, organization: @org1, person: @person4, permission: Permission.admin)
    ...
    should "return null if no admin has email" do
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person3, permission: Permission.admin)
      @person3.email_addresses.destroy_all
      FactoryGirl.create(:organizational_permission, organization: @org3, person: @person4, permission: Permission.admin)
      @person4.email_addresses.destroy_all
      results = @org3.all_possible_admins_with_email
  ...
  test "test to_s()" do # Every model, in this application, should return .name of the record
    org1 = FactoryGirl.create(:organization, :name => "Chupakabra")
  ...
  test "self and children" do
    ...
    person3 = FactoryGirl.create(:person, email: "person3@email.com")
		...
		FactoryGirl.create(:organizational_permission, organization: @org, person: person2, permission: Permission.user)
		FactoryGirl.create(:organizational_permission, organization: @org, person: person3, permission: Permission.admin)
		FactoryGirl.create(:organizational_permission, organization: @org, person: person3, permission: Permission.user)
		@org.leaders.inspect
	end
  ...
  test "self and children surveys" do
    ...
    survey1 = FactoryGirl.create(:survey, :organization => org1)
    survey2 = FactoryGirl.create(:survey, :organization => org2)
  ...
  test "self and children keywords" do
    org1 = FactoryGirl.create(:organization)
    org2 = FactoryGirl.create(:organization, :parent => org1)
    keyword1 = FactoryGirl.create(:sms_keyword, :organization => org1)
    keyword2 = FactoryGirl.create(:sms_keyword, :organization => org2)
  ...
  context "retrieving active keywords" do
    setup do
      ...
      @org1 = FactoryGirl.create(:organization)
      @org2 = FactoryGirl.create(:organization)
      @keyword1 = FactoryGirl.create(:sms_keyword, :organization => @org1, state: 'active')
      @keyword2 = FactoryGirl.create(:sms_keyword, :organization => @org1, state: 'active')
      @keyword3 = FactoryGirl.create(:sms_keyword, :organization => @org2, state: 'active')
      @keyword4 = FactoryGirl.create(:sms_keyword, :organization => @org1)
      @keyword5 = FactoryGirl.create(:sms_keyword, :organization => @org2)
    end
  ...
  test "<=>(other)" do
    org1 = FactoryGirl.create(:organization, :name => "Zulu")
    org2 = FactoryGirl.create(:organization, :name => "Yack")
  ...
  test "add_leader(person)" do
    user1 = FactoryGirl.create(:user_with_auxs)  #user with a person object
    user2 = FactoryGirl.create(:user_with_auxs)
    org = FactoryGirl.create(:organization)

    FactoryGirl.create(:email_address, email: 'user1@email.com', person: user1.person)
    FactoryGirl.create(:email_address, email: 'user2@email.com', person: user2.person)
    user1.person.reload
    user2.person.reload
    org.add_leader(user1.person, user2.person)
    org_permission = OrganizationalPermission.where(person: user1.person).last
  ...
  test "using add_leader(person) in deleted leader" do
    user1 = FactoryGirl.create(:user_with_auxs)  #user with a person object
    user2 = FactoryGirl.create(:user_with_auxs)
    user3 = FactoryGirl.create(:user_with_auxs)
    org = FactoryGirl.create(:organization)

    # Add Leader
    FactoryGirl.create(:email_address, email: 'leader1@email.com', person: user1.person)
    FactoryGirl.create(:email_address, email: 'leader2@email.com', person: user2.person)
    FactoryGirl.create(:email_address, email: 'leader3@email.com', person: user2.person)
    user1.person.reload
    user2.person.reload
    user3.person.reload
    org.add_leader(user1.person, user2.person)
  ...
  test "move contact with survey answers" do
    ...
    survey = FactoryGirl.create(:survey, organization: org1, title: "Special Survey")
  ...
  test "move contact with multiple survey answers" do
    ...
    answer_sheet = FactoryGirl.create(:answer_sheet, survey: survey, person: contact)
    answer1 = FactoryGirl.create(:answer_1, answer_sheet: answer_sheet, question: question)
    answer2 = FactoryGirl.create(:answer_1, answer_sheet: answer_sheet, question: question)
  ...
  test "move contact with interactions" do
    ...
    interaction = FactoryGirl.create(:interaction, receiver: contact, creator: person, organization: org1, interaction_type_id: interaction_type.id)
  ...
  context "an organization" do
    ...
    should "delete suborganizations when deleted (root organizations cannot be deleted)" do
      ...
      org1 = FactoryGirl.create(:organization)
      org2 = FactoryGirl.create(:organization, :parent => org1)
      org3 = FactoryGirl.create(:organization, :parent => org2)
      org4 = FactoryGirl.create(:organization, :parent => org3)
      org5 = FactoryGirl.create(:organization, :parent => org4)
  ...
  test "add initial admin after creating an org" do
    ...
    assert_difference "OrganizationalPermission.count", 1 do
      FactoryGirl.create(:organization, person_id: person.id)
    end
  end
  ...
  context "Testing the uniqueness of an orgs children" do
    setup do
      @org = FactoryGirl.create(:organization)
      @child = FactoryGirl.create(:organization, parent: @org, name: 'org', terminology: 'org')
  ...
  context "fetching transfers for 100% Sent" do
    setup do
      ...
      FactoryGirl.create(:organizational_permission, person: @admin, permission: Permission.admin, organization: @org)
      ...
      FactoryGirl.create(:interaction, interaction_type_id: other_interaction.id, receiver: @contact3, creator: @admin, organization: @other_org)
    end
  ...
  context "fetching labels" do
    setup do
      ...
      @child_org = FactoryGirl.create(:organization, ancestry: '1')
      @not_child_org = FactoryGirl.create(:organization, ancestry: nil)
    end
    ...
    should "return 'seeker' label for bridge org" do
      @bridge_org = FactoryGirl.create(:organization, name: 'Bridges at Sample', ancestry: @org.id)
  ...
  context "getting sms_gateway" do
    setup do
      @parent1 = FactoryGirl.create(:organization, name: 'Parent1', ancestry: nil)
      @parent2 = FactoryGirl.create(:organization, name: 'Parent2', ancestry: "#{@parent1.id}")
      @parent3 = FactoryGirl.create(:organization, name: 'Parent3', ancestry: "#{@parent1.id}/#{@parent2.id}")
