export default {
  common: {
    ...
    application: {
      ...
      assign_search: {
        ...
        notify_person: 'Type the name of a person you want us to notify',
      },
      interaction_types: {
    ...
    contacts: {
      ...
      index: {
        filter: 'Search',
        for_this_permission_email_is_required: "Email is required for '{{permission}}' permission.",
        for_this_permission_email_is_required_no_name: 'Email is required for this permission.',
        import_contacts: 'Import Contacts',
        search_contact_results_description: 'Please use the form to find a contact.',
    ...
    dashboard: {
      ...
      error_archiving_person: 'Error archiving person! Please try again or contact support.',
      ...
      no_contacts_help: {
        ...
        part2: 'or someone gets assigned to you, they will show up here.',
      },
      ...
      suggestIosAddToHomeScreen: {
        ...
        description: "Add Campus Contacts on your home screen for quick access when you're on the go.",
    ...
    error: {
      ...
      messages: {
        assigned_select: {
          search_people: 'Error occurred while loading the assignment choices',
        },
        bulk_message_modal: {
          send_message: 'Error occurred while trying to send message',
        },
        bulk_transfer_modal: {
          transfer_contacts: 'Error occurred while trying to transfer contacts',
        },
        edit_group_or_label_assignments: {
          load_groups: "Error occurred while loading the user's groups",
          load_labels: "Error occurred while loading the user's labels",
        },
        group_members: {
          add_member: 'Error occurred while adding the person to the group',
          load_member_chunk: 'Error occurred while loading the next batch of group members',
          remove_member: 'Error occurred while removing the person from the group',
        },
        groups: {
          create_group: 'Error occurred while creating the group',
          delete_group: 'Error occurred while deleting the group',
          load_leaders: "Error occurred while loading the group's leaders",
        ...
        interactions: {
          create_interaction: 'Error occurred while creating the interaction',
          delete_interaction: 'Error occurred while deleting the interaction',
          update_interaction: 'Error occurred while updating the interaction',
        },
        labels: {
        ...
        logged_in_person: {
          load_user: 'Error occurred while loading your user information',
        },
        mass_edit: {
          apply_mass_edit: 'Error occurred while mass editing the contacts',
        ...
        my_people_dashboard: {
          ...
          update_org_order: 'Error occurred while updating the organization order',
          update_org_visibility: 'Error occurred while updating the organization visibility',
        },
        organization: {
          ...
          load_ancestry: "Error occurred while loading the organization's ancestors",
          cleanup: 'Error occurred while archviving contacts',
          loadAll: 'Error occurred while loading your organizations',
        },
        organization_overview: {
          load_org_relationships: "Error occurred while loading the organization's groups and surveys",
        },
        organization_overview_people: {
          load_assignments: 'Error occurred while loading the people assigned to these people',
          load_org_people_count: 'Error occurred while loading the number of people in the organization',
          load_people_chunk: 'Error occurred while loading the next batch of people',
        },
        organization_overview_suborgs: {
          load_org_chunk: 'Error occurred while loading the next batch of sub-organizations',
          load_org_suborg_count: 'Error occurred while loading the number of sub-organizations in the organization',
        },
        organization_overview_team: {
          load_org_team_count: 'Error occurred while loading the number of team members in the organization',
          load_team_chunk: 'Error occurred while loading the next batch of team members',
        },
        people_filters_panel: {
          load_filter_stats: 'Error occurred while loading the filter counts',
        },
        person: {
          archive_person: 'Error occurred while archiving the person',
          get_contact_assignments: 'Error occurred while loading load the people this person is assigned to',
          search: 'Error loading search results',
        },
        person_page: {
          create_person: 'Error occurred while creating the person',
          delete_avatar: 'Error occurred while removing the profile picture',
          upload_avatar: 'Error occurred while uploading the profile picture',
        },
        person_profile: {
          delete_relationships: 'Error occurred while updating the person',
          reload_merged_person: 'Error occurred while refreshing the person',
          update_person: 'Error occurred while updating the person',
        },
        preferences_page: {
          update_preferences: 'Error occurred while updating the preferences',
        },
        progressive_list_loader: {
          load_chunk: 'Error occurred while loading the items',
        },
        reports: {
          load_org_reports: "Error occurred while loading the organization's reports",
          load_person_report: "Error occurred while loading the person's report",
        },
        routes: {
          get_history: "Error occurred while loading the person's history",
          get_organization: 'Error occurred while loading the organization',
          get_person: 'Error occurred while loading the person',
          get_survey: 'Error occurred while getting survey data',
        },
        surveys: {
          loadQuestions: 'Error occurred while loading survey questions',
        },
        surveyResponses: {
        ...
        inviteLink: {
          loadRemeberToken: 'Error occurred while loading invite information',
          mergeAccount: 'Error occurred while merging your accounts',
        },
        signature_request: 'Error occurred, the agreement could not be processed',
    ...
    group: 'Group',
    groups: {
      confirm_delete_group: 'Are you sure you want to delete "{{group_name}}"?',
      edit: {
      ...
      members: {
        ...
        contacts: 'contacts',
        leader: 'Leader',
        remove_confirm: 'Are you sure you want to this member from the group?',
    ...
    interactions: {
      delete_confirmation: 'Are you sure you want to delete this interaction?',
    },
    label: 'Label',
    labels: {
      delete: {
        confirm: 'Are you sure you want to delete the "{{label_name}}" label?',
      },
      edit: {
    ...
    login: {
      signIn: 'Sign in',
      inviteInProgress: 'To complete your invite, create account or sign in.',
      signUpWithEmail: 'Sign Up with Email',
      signInWithEmail: 'Sign In with Email',
      continueWithFacebook: 'Continue with Facebook',
    },
    mergeAccount: {
      loggedInAs: 'You are current logged in as {{fullName}} <{{email}}>.',
      continue: 'Do you want to continue?',
      mergeAccount: 'Yes, merge {{fullName}} <{{username}}> into my account.',
      ...
      inviteLinkExpiredTitle: 'Sorry, the invite link has expired or is no longer valid.',
    ...
    authLanding: {
      title: 'SUCCESS!',
      thanksForVerifying: 'Hi, so it is you! Thanks for verifying your new Campus Contacts account.',
      allSet: "You're all set to Sign In on your mobile app.",
      excitedForYouToGrow: "We're excited for you to grow closer to God by helping others experience him.",
    },
    leader: 'Leader',
    mass_edit: {
    ...
    ministries: {
      ...
      cleanup: {
        ...
        archive_by_date_description: 'Archive contacts who have been added before:',
        archive_by_date_confirm_message: 'Are you sure you want to archive these contacts by date?',
        archive_by_inactivity: 'Archive by inactivity',
        archive_by_inactivity_confirm_message: 'Are you sure you want to archive these contacts by inactivity?',
        archive_by_inactivity_description: 'Archive people who have been inactive since:',
      ...
      people: {
        ...
        archive_people_confirm: 'Are you sure you want to archive {{contact_count}} contacts?',
        assigned: {
          header: 'Assigned',
        },
        clear_selection_hover: 'Unselect all of the selected contacts',
        delete_hover: 'Delete the selected contacts',
        delete_people_confirm: 'Are you sure you want to delete {{contact_count}} contacts?',
        ...
        status: 'Status',
        transfer_hover: 'Transfer the selected contacts to another organization',
      ...
      surveys: {
        ...
        typeform: {
          ...
          step1: 'Sign up for an account at <a href="https://typeform.com" target="_blank">typeform.com</a>.',
          step2:
          ...
          step3: 'Copy the Campus Contacts URL below into the Destination URL field on Typeform.',
          step4:
          ...
          step5: 'Next to the webhooks title click the slider to enable webhooks.',
          conclusion: 'Future form submissions for this survey will be sent to Campus Contacts automatically.',
      ...
      noMinistriesFound: 'Sorry you have no ministries linked to this account.',
    },
    monthly: 'Monthly',
    nav: {
      about: {
    ...
    organizations: {
      ...
      name: 'Ministry Name',
      type: 'Type',
      type_help: 'This is how you want to identify this specific ministry. Some people use church, group, or team.',
      ...
      cleanup: {
        confirm_archive: 'Are you sure you wanted to archive the desired contacts?',
      },
    },
    people: {
      edit: {
        cancel_create_confirm: 'Are you sure you want to discard this unsaved contact?',
        delete_address_confirm: 'Are you sure you want to delete this address?',
        delete_email_confirm: 'Are you sure you want to delete this email address?',
        delete_phone_confirm: 'Are you sure you want to delete this phone number?',
      },
      index: {
      ...
      show: {
        ...
        apply_labels_undefined: 'Apply the following labels to this person.',
        apply_groups: 'Assign {{name}} to the following groups.',
        apply_groups_undefined: 'Assign this person to the following groups.',
    ...
    person_multiselect: {
      no_search_results: 'No {{people_description}} found matching "{{search}}"',
    ...
    signatures: {
      ...
      agreements: {
        ...
        declined: {
          ...
          requestAccessBlurb: 'You will need to request access again after having this discussion.',
        },
        codeOfConduct: {
    ...
    transfer: {
      ...
      subtitle: 'Transfer {{contact_count}} contact(s) to another organization.',
  ...
  phoneNumbers: {
    validations: {
      ...
      inactiveOrInvalid: 'Your survey submission is inactive or your link is invalid.',
    },
  },
  surveys: {
    preview: 'Preview',
    publicView: {
      preview: {
        ...
        description: 'While in preview mode, you cannot submit survey responses.',
      },
      post_survey_message: 'Thanks! Your survey has been successfully submitted.',
      surveyNotFound: 'This survey could not be found',
      inactiveOrInvalid: 'The survey you are trying to view is inactive or your link is invalid.',
    },
    delete: {
    ...
    settings: {
      ...
      validation_message_hint: 'This message will be sent via SMS with a short link.',
      ...
      validation_success_message_hint: 'When they visit the short link in the SMS this message will be shown.',
    },
    keyword: {
      keyword: 'Keyword',
      keyword_example: 'Example: Cookies',
      instructions: 'Use at least 3 letters (no special characters/spaces)',
      help:
      ...
      response_example: 'Example: Thanks for taking our survey! Press {{ link }}.',
  ...
  contact_import: {
    step_1: {
      ...
      instructions: 'Select a survey to import your contacts from the drop down menu below.',
    ...
    step_4: {
      title: 'You Rock!',
      instructions: 'Your CSV upload is now being processed. You will receive an email when it finishes.',
      home: 'Take Me Home',
    },
    errors: {
      bulkImport: 'Error occurred while importing contacts from your CSV file',
      save: 'Error occurred while saving contact',
    },
  },
  unsubscribe: {
    confirmation: 'Are you sure you want to unsubscribe from all emails from',
    noMoreEmails: 'By unsubscribing, you will no longer receive emails from',
    success: 'Thanks! You have successfully unsubscribed and will no longer receive emails from',
    label: 'Unsubscribe',
    error: 'We are sorry, but an error has occurred. Please try again by refreshing the page.',
  },
  userPreferences: {
    ...
    personTransferred: 'When a person is transferred to one of my organizations',
  ...
  movementIndicators: {
    ...
    suggestedActions: {
      ...
      applyAll: 'Apply All',
      reasonPhrases: {
        spiritualConversation: 'had a spiritual conversation with someone.',
      ...
      applyLabel: 'Apply the <strong>&quot;{{label}}&quot;</strong> label?',
      errorLoadingSuggestedActions: 'Error occurred while loading the suggested actions',
      errorSavingSuggestedActions: 'Error occurred while saving the suggested actions',
    },
    confirmIndicators: {
      title: 'Confirm Movement Indicators',
      loading: 'Loading movement indicators…',
      submittedInLastWeek: {
        heading: 'Movement Indicators for this ministry are up to date.',
        description:
          'Movement Indicators have been submitted for the past week. Please check back next week to submit these again.',
        descriptionContinued: "If you'd like to change any numbers previously submitted, please do so in Infobase.",
      },
      interactionsHeading:
      ...
      errorLoadingIndicators: 'Error occurred while loading movement indicators to pre-fill fields',
      errorSavingIndicators: 'Error occurred while saving movement indicators',
    },
    interactions: {
      title: 'Interactions',
    ...
    students: {
      ...
      involved: {
        label: 'Involved',
        tooltip: 'How many students are regularly involved and attending movement events?',
      },
      engaged: {
