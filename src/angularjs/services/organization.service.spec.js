...
describe('organizationService', function() {
  ...
  describe('getOrgHierarchyIds', function() {
    ...
    it('should handle orgs with no ancestry', function() {
      expect(organizationService.getOrgHierarchyIds(this.orgs[1])).toEqual([
        '1',
      ]);
    });

    it('should handle orgs with ancestry', function() {
      expect(organizationService.getOrgHierarchyIds(this.orgs[3])).toEqual([
        '1',
        '2',
        '3',
      ]);
      ...
      asynchronous(function() {
        ...
        return organizationService
          ...
          .then(function(orgs) {
            ...
            expect(organizationService.loadOrgs).toHaveBeenCalledWith(
              [],
              jasmine.any(String),
            );
          });
