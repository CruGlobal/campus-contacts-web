...
function personService(
  ...
  var personService = {
    ...
    getOrgPermission: function(person, organizationId) {
      return _
        .chain(person.organizational_permissions)
    ...
    isContact: function(person, organizationId) {
      ...
      return orgPermission
        ? orgPermission.permission_id === permissionService.noPermissionId
        : false;
    },
      ...
      return httpProxy
        ...
        .then(function(assignedPeople) {
          ...
          function isAssignmentInCurrentOrganization(assignment) {
            return (
              _.isNil(organizationId) ||
              _.get(assignment, 'organization.id') === organizationId
            );
          }
          ...
          return _.flatten(
            assignedPeople.map(function(assignedPerson) {
              ...
              return assignedPerson.reverse_contact_assignments.filter(function(
                assignment,
              ) {
