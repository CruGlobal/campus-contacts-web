  ...
  describe('callHttp', function() {
    ...
    it(
      ...
      asynchronous(function() {
        ...
        return httpProxy
          .callHttp(this.method, this.url, this.params, this.data)
          .then(function() {
            expect(JsonApiDataStore.store.syncWithMeta).toHaveBeenCalledWith(
              _this.responseData,
            );
          });
      }),
    ...
    it(
      ...
      asynchronous(function() {
        ...
        return httpProxy
          .callHttp(this.method, this.url, this.params, this.data, config)
          .then(function() {
  ...
  describe('model loading', function() {
    ...
    describe('getUnloadedRelationships', function() {
      it('should treat all relationships as unloaded when the model is null', function() {
        ...
        expect(
          httpProxy.getUnloadedRelationships(null, this.relationships),
      ...
      it('should correctly detect unloaded relationships', function() {
        ...
        expect(
          httpProxy.getUnloadedRelationships(this.model, this.relationships),
    ...
    describe('getModel', function() {
      ...
      it(
        ...
        asynchronous(function() {
          ...
          var _this = this;
          return httpProxy
            .getModel(this.url, this.type, this.id, this.relationships)
            .then(function(model) {
