class MergeDuplicateSurveysInOrganization5499 < ActiveRecord::Migration
  def up
    # Reported in Jira MH-1040
    ...
    if to_org.present?
      ...
      if duplicates.present?
        ...
        to_org.merge_duplicate_surveys_by_title(duplicates.collect(&:title), from_org, true)
