...
class AddDefaultInteractionTypes < ActiveRecord::Migration
  def up
    ...
    InteractionType.create(organization_id: 0, name: "Spiritual Conversation", i18n: "spiritual_conversion")
  ...
  def down
    ...
    defaults.where(i18n: "spiritual_conversion").try(:first).try(:destroy)
