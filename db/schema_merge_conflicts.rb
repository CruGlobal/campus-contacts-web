...
<<<<<<< HEAD
ActiveRecord::Schema.define(:version => 20110526125711) do
=======
ActiveRecord::Schema.define(:version => 20110523171721) do
>>>>>>> 0e672aa4c3b4282b34775e7d1785d82bc86de9c8
...
>>>>>>> 0e672aa4c3b4282b34775e7d1785d82bc86de9c8
  ...
  add_index "ma_answers", ["answer_sheet_id"], :name => "index_ma_answers_on_answer_sheet_id"
  add_index "ma_answers", ["question_id"], :name => "index_ma_answers_on_question_id"
  add_index "ma_answers", ["short_value"], :name => "index_ma_answers_on_short_value"

  create_table "ma_conditions", :force => true do |t|
    t.integer "question_sheet_id", :null => false
  ...
  create_table "ma_elements", :force => true do |t|
  ...
  add_index "ma_elements", ["conditional_id"], :name => "index_ma_elements_on_conditional_id"
  add_index "ma_elements", ["position"], :name => "index_ma_elements_on_question_sheet_id_and_position_and_page_id"
  add_index "ma_elements", ["question_grid_id"], :name => "index_ma_elements_on_question_grid_id"
  add_index "ma_elements", ["slug"], :name => "index_ma_elements_on_slug"

  create_table "ma_email_templates", :force => true do |t|
  ...
  add_index "ma_email_templates", ["name"], :name => "index_ma_email_templates_on_name", :length => {"name"=>255}

  create_table "ma_page_elements", :force => true do |t|
    t.integer  "page_id"
  ...
  create_table "ma_question_sheets", :force => true do |t|
  ...
  add_index "ma_question_sheets", ["questionnable_id", "questionnable_type"], :name => "questionnable"

  create_table "ma_references", :force => true do |t|
    t.integer  "question_id"
