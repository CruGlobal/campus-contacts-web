...
const { entry, devServer, optimization, ...webpackConfig } = require('./webpack.config.js')({ test: true });
...
const karmaWebpackConfig = {
  ...
  plugins: [
    ...
    new webpack.NormalModuleReplacementPlugin(/\.(svg|gif|png|jpg|jpeg|(sa|sc|c)ss)$/, 'node-noop'),
  ],
};
