...
Devise.setup do |config|
  ...
  # config.pepper = "ed3bfbad15fa7e36044f9b8312b6ef7a08d9a16121166423bbc6a4de401de25b25f562542e923f83454ac9415e229260d2edf7bcf3db4dc8f2931439883230b3"
  ...
  # config.omniauth :github, 'APP_ID', 'APP_SECRET', :scope => 'user,public_repo'
  config.omniauth :facebook, FB_APP_ID, FB_SECRET, :scope => 'user_about_me,user_birthday,email,publish_stream,offline_access'
